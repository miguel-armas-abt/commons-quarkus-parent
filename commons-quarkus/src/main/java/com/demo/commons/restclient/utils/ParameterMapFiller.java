...
public class ParameterMapFiller {
  ...
  public static Consumer<Map<String, String>> addGeneratedParams(Map<String, AutoGeneratedParam> generatedParams) {
    return params -> Optional.ofNullable(generatedParams).ifPresent(paramMap -> paramMap
        .forEach((headerKey, autoGeneratedParam) -> params.put(headerKey, autoGeneratedParam.getGenerator().get())));
  }
