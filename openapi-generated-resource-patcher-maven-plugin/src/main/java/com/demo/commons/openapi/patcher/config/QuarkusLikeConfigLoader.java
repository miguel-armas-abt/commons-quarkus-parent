package com.demo.commons.openapi.patcher.config;
...
public final class QuarkusLikeConfigLoader {

  private static final int APPLICATION_FILE_ORDINAL = 250;

  private QuarkusLikeConfigLoader() {
  }
  ...
  public static SmallRyeConfig load(File projectBaseDir) throws MojoExecutionException {
    SmallRyeConfigBuilder builder = new SmallRyeConfigBuilder()
        ...
        .withMapping(OpenApiGeneratedResourcePatcherConfig.class);
    ...
    try {
      ...
      throw new MojoExecutionException("Cannot read Quarkus application config.", ex);
    }
  }

  private static java.util.Map<String, String> propertiesToMap(Properties properties) {
